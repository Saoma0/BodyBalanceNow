...
{
    public partial class RegistroPesoWindows : ContentPage
    {
        private readonly ExerciseDatabase database = new ExerciseDatabase(); // base de datos Windows
        ...
        protected override async void OnAppearing()
        {
            ...
            {
                HistorialPesoView.ItemsSource = null;
            }
        }
        ...
        // Método para cargar el historial de peso
        private async void CargarHistorial()
        {
            ...
            HistorialPesoView.ItemsSource = historial;
        }

        // Método para cargar el gráfico de peso
