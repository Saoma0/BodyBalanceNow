...
public partial class TiempoAndroid : ContentPage
{
    ...
    // Método para seleccionar el modo de cronómetro o temporizador
    ...
    // Métodos para manejar los eventos de los botones del cronómetro
    ...
    //  Método para manejar el evento de registrar vuelta del cronómetro
    ...
    // ------------------- TEMPORIZADOR -------------------
    // Método para manejar el evento de detener el cronómetro
    ...
    // Métodos para manejar los eventos de los botones del temporizador
    ...
    // Método para manejar el evento de detener el temporizador
    ...
    // Método para manejar el evento de selección del cronómetro
