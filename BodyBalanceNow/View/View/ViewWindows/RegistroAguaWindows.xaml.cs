...
public partial class RegistroAguaWindows : ContentPage
{
    ...
    public ObservableCollection<RegistroAgua> RegistrosAgua { get; set; } //  Colección para el historial de agua
    private int totalConsumidoHoy = 0; //  Total consumido hoy

    public RegistroAguaWindows()
    {
        InitializeComponent();
        RegistrosAgua = new ObservableCollection<RegistroAgua>();
    ...
    protected async override void OnAppearing()
    {
        ...
        await CargarGraficoSemanalCasero(); //  IMPORTANTE: Esto siempre se ejecuta
    }
