...
public partial class RegistroEstresWindows : ContentPage
{
    private ExerciseDatabase baseDeDatos = new ExerciseDatabase(); // Base de datos para Windows
    ...
    private async Task CargarHistorialEstres()
    {
        try
        {
            ...
            historialTitleLabel.IsVisible = RegistrosEstres.Count > 0;
        ...
        {
            Debug.WriteLine($"Error al cargar el historial: {ex.Message}");
        }
    }
